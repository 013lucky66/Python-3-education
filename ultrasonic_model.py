...
plt.plot(spisok_qm, dKgdin, linewidth = '3', linestyle = 'dashed', label='Погрешность гидродинамического коэффициента')
plt.plot(spisok_qm, ddTdin, linewidth = '3', linestyle = 'solid', label='Погрешность разности времен распространения УЗС')
plt.legend(loc='best')
plt.show()
plt.show()
