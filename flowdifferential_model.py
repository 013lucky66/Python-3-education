...
plt.plot(spisok_qm, dCdin, linewidth = '3', linestyle='solid', label='Погрешность коэффициента истечения')
plt.plot(spisok_qm, ddpdin, linewidth = '3', linestyle='dashed', label='Погрешность перепада давлений')
plt.legend(loc='best')
plt.show()
